...
const Contact = () => {
  ...
  return (
    ...
    <div id='contact' className=' font-xl  flex items-center md:px-12 lg:px-16 xl:px-22 py-16 pt-8 md:mx-40 mx-8 justify-center '>
      <h2 className='w-1/2 text-2xl font-bold mb-4 text-white
      text-center'>Contact Me</h2>
      <form onSubmit={handleSubmit}>

      <div className='mb-4'>
        <label className='block text-gray-800 text-sl font-medium'>NAME:</label>
        <input
          type="text"
          name="name"
          value={formData.name}
      ...
      <div className='mt-8'>
        ...
        <label className='block text-gray-800 text-sl font-medium mt-2 p-3'>EMAIL:</label>
        <input
          type='email'
          name="email"
      ...
      <div className='mt-8'>
          <label className='block text-gray-800 text-sl font-medium py-2'>MESSAGE:</label>
          <textarea
            name="message"
