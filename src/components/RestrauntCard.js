...
const RestrauntCard = ({ restaurant }) => {
  ...
  return (
      ...
      <div className="h-[295.98px] w-full rounded-lg box-border  flex flex-col items-start justify-center hover:scale-105 shadow-md transition-all p-2  ">
        <img
          className="overflow-hidden w-full object-cover rounded-md"
        ...
        <div className="w-full ">
          <span className="flex flex-row w-full items-center justify-between">
            <h4 className="bg-green-600 rounded text-white text-xs flex px-1 py-1  justify-between items-center gap-2">
